...
expr    : SYMLP expr SYMRP      {   $$=  $2;  }
        ...
        | NUMBER                {   $$= $1;  }     
        | NUMBER error          {   HandleError("wrong number"); $$=INT_MAX; }
        | error                 {   HandleError("wrong arifmetic expression"); $$=INT_MAX;  }
        | IDENTIFIER error      {   HandleError("wrong identifier"); $$=INT_MAX; }
